...
export default function InterviewQuestion2() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-slate-900 px-8 pt-6 pb-12">
            ...
            {/* Header Section */}
            <View>
                <Text className="text-[#94A3B8] text-sm font-bold mb-4 uppercase tracking-widest">Question 2 of 5</Text>
                <Text className="text-white text-4xl font-bold leading-tight mb-2">
                    How soon do you want to achieve your main goal?
                </Text>
            ...
            <View className="flex-row justify-between items-center mt-4">
                ...
                <Pressable
                    onPress={() => selected && router.replace("/question3" as any)}
