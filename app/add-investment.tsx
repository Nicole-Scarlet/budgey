                ...
                >
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View>
                                ...
                                <View className="flex-row flex-wrap" style={{ gap: 16 }}>
                                    {categories.filter(c => c.type.toLowerCase() === 'investment').length > 0 ? (
                                        categories.filter(c => c.type.toLowerCase() === 'investment').map(cat => {
                                        ...
                                        <TouchableOpacity
                                            onPress={() => router.push(`/add-category?module=Investment` as any)}
                        ...
                        <View className="px-8 py-6 pb-12" style={{ backgroundColor: colors.background }}>
                            <Pressable
                                ...
                                style={{ backgroundColor: (amount && parseFloat(amount) <= 1000000000 && !isSaving) ? '#A855F7' : colors.card, opacity: (amount && parseFloat(amount) <= 1000000000) ? 1 : 0.5 }}
                            >
                                {isSaving ? (
