...
export default function InvestmentScreen() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-[#1E293B]" onLayout={(e) => setContainerHeight(e.nativeEvent.layout.height)}>
            <View onLayout={(e) => setHeaderHeight(e.nativeEvent.layout.height)}>
                ...
                <View className="bg-[#334155] rounded-b-[40px] pt-8 pb-10 shadow-lg relative z-50">
                    ...
                    >
                        ...
                        {investmentLimit > 0 ? (
                            <Pressable onPress={() => { setIsCategoryMenuVisible(false); setTempLimit(investmentLimit.toString()); setTempPeriod(investmentLimitPeriod); setIsLimitModalVisible(true); }} className="bg-[#1E293B] px-4 py-2 rounded-full border border-[#90A1B9]/30">
            ...
            {/* Bottom Sheet for Investment Summary */}
            <BottomSheet
                ref={bottomSheetRef}
                index={1}
                ...
                <BottomSheetScrollView contentContainerStyle={{ paddingHorizontal: 24, paddingBottom: 40, paddingTop: 20 }}>
                    {investmentTransactions.length === 0 ? (
                        <View className="items-center justify-center pt-10 pb-20">
                            ...
                            <Text className="text-[#94A3B8] text-lg mt-4 text-center px-4">No investments recorded yet.</Text>
                        </View>
                    ) : (
                ...
                >
                    <Pressable onPress={() => { }} className="w-full">
                        <View className="bg-[#1E293B] w-full rounded-3xl p-6 border border-[#334155] shadow-2xl">
                            <Text className="text-white text-xl font-bold mb-4">Set Investment Goal</Text>
                            <Text className="text-slate-400 text-sm mb-4">Enter your target investment goal below:</Text>
                                ...
                                <Pressable
                                    onPress={() => {
                                        ...
                                        if (!isNaN(parsedLimit) && parsedLimit > 0 && parsedLimit <= 1000000000) {
                                            ...
                                            setInvestmentLimit(0); // clear if empty
                                            setIsLimitModalVisible(false);
                                        }
                                    }}
