                ...
                <BottomSheetScrollView contentContainerStyle={{ paddingHorizontal: 24, paddingBottom: 40, paddingTop: 20 }}>
                    {incomeTransactions.length === 0 ? (
                        <View className="items-center justify-center pt-10 pb-20">
                            ...
                            <Text className="text-lg mt-4 text-center px-4" style={{ color: colors.muted }}>No income recorded yet.</Text>
                        </View>
                    ) : (
            ...
            >
                ...
                >
                    <Pressable onPress={() => { }} className="w-full">
                        ...
                        >
                            <Text className="text-xl font-bold mb-4" style={{ color: colors.foreground }}>Set Income Goal</Text>
                            <Text className="text-sm mb-4" style={{ color: colors.muted }}>Enter your target income amount below:</Text>
                                ...
                                <Pressable
                                    onPress={async () => {
                                        ...
                                        if (!isNaN(parsedGoal) && parsedGoal > 0 && parsedGoal <= 1000000000) {
                                            await setIncomeGoal(parsedGoal);
                                            await setIncomeGoalPeriod(tempPeriod);
                                            setIsGoalModalVisible(false);
                                        } else if (tempGoal === '' || parsedGoal === 0) {
                                            await setIncomeGoal(0);
                                            setIsGoalModalVisible(false);
                                        }
                                    }}
