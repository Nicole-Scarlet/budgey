            ...
            <View onLayout={(e) => setHeaderHeight(e.nativeEvent.layout.height)}>
                ...
                <View className="bg-[#334155] rounded-b-[40px] pt-8 pb-10 shadow-lg relative z-50">
                    ...
                    >
                        ...
                        {incomeGoal > 0 ? (
                            <Pressable onPress={() => { setTempGoal(incomeGoal.toString()); setTempPeriod(incomeGoalPeriod); setIsGoalModalVisible(true); }} className="bg-[#1E293B] px-4 py-2 rounded-full border border-[#90A1B9]/30">
                            ...
                            <Pressable
                                onPress={() => {
                                    ...
                                    if (!isNaN(parsedGoal) && parsedGoal > 0) {
                                        ...
                                        setIncomeGoal(0); // clear if invalid/empty
                                    }
                                    setIsGoalModalVisible(false);
                                }}
                                className="px-6 py-3 rounded-xl bg-[#4ADE80]"
                            >
                                <Text className="text-[#0F172A] font-bold">Save Goal</Text>
                            </Pressable>
                        </View>
                    </View>
                </View>
