...
const TermsPage = () => {
    ...
    const Section = ({ title, content }: { title: string, content: string }) => (
        <View className="mb-8">
            <Text className="text-lg font-bold mb-3" style={{ color: colors.foreground }}>{title}</Text>
            <Text 
    ...
    return (
        <SafeAreaView className="flex-1" style={{ backgroundColor: colors.background }}>
            ...
            <View className="flex-row items-center justify-between px-6 py-4">
                ...
                <Text className="text-xl font-bold" style={{ color: colors.foreground }}>Terms & Conditions</Text>
                <View className="w-10" />
            </View>

            <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 60 }}>
                <View className="mt-6 mb-10">
                    <Text className="text-sm mb-2" style={{ color: colors.muted }}>Last Updated: March 1, 2026</Text>
                    <Text className="text-2xl font-black" style={{ color: colors.foreground }}>Agreement to Terms</Text>
                    <View className="h-1 w-12 mt-4 rounded-full" style={{ backgroundColor: colors.foreground }} />
                </View>
                ...
                <View className="mt-4 pt-8 border-t" style={{ borderTopColor: colors.border + '33' }}>
                    <Text className="text-sm text-center italic" style={{ color: colors.muted }}>
