                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View>
                                ...
                                <View className="flex-row flex-wrap" style={{ gap: 16 }}>
                                    {categories.filter(c => c.type.toLowerCase() === 'savings').length > 0 ? (
                                        categories.filter(c => c.type.toLowerCase() === 'savings').map(cat => {
                                        ...
                                        <TouchableOpacity
                                            onPress={() => router.push(`/add-category?module=Savings` as any)}
